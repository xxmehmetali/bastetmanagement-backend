...
public class ApplicantMeetingController extends BaseController {
    ...
    public Result update(@RequestBody ApplicantMeetingDto applicantMeetingDto) {
        boolean success = applicantMeetingFacade.update(applicantMeetingDto);
        return wrapResultWithMessage(success, ResultConstants.updatedMessage(ApplicantMeeting.class));
    }
