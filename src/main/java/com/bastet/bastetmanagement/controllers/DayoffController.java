...
public class DayoffController extends BaseController {
    ...
    public Result update(@RequestBody DayoffDto dayoffDto) {
        boolean success = dayoffFacade.update(dayoffDto);
        return wrapResultWithMessage(success, ResultConstants.updatedMessage(Dayoff.class));
    }
