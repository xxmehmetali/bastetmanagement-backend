...
public class SocialActivityTypeController extends BaseController {
    ...
    public Result update(@RequestBody SocialActivityTypeDto socialActivityTypeDto) {
        boolean success = socialActivityTypeFacade.update(socialActivityTypeDto);
        return wrapResultWithMessage(success, ResultConstants.updatedMessage(SocialActivityType.class));
    }
