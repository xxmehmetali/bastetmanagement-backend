...
public class MeetingPlatformController extends BaseController {
    ...
    public Result update(@RequestBody MeetingPlatformDto meetingPlatformDto) {
        boolean success = meetingPlatformFacade.update(meetingPlatformDto);
        return wrapResultWithMessage(success, ResultConstants.updatedMessage(MeetingPlatform.class));
    }
